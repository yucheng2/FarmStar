...
export default defineConfig({
  ...
  shortcuts: {
    'btn-primary': 'bg-primary text-primary-foreground rounded-full px-5 py-2.5 font-semibold text-sm transition-all cursor-pointer border-none shadow-md hover:bg-[#166534] active:scale-98',
    ...
    'btn-secondary-active': 'bg-primary text-primary-foreground border-primary',
    'card': 'bg-card rounded-lg shadow-md p-4',
    'input-field': 'bg-transparent px-4 py-3 text-sm text-foreground w-full box-border transition-all focus:outline-none shadow-[0_2px_0_0_#9ca3af] focus:shadow-[0_2px_0_0_#15803D]',
