...
<template>
  ...
  >
    ...
    <view
      class="rounded-full bg-primary/10 text-white text-xs border-0 cursor-pointer transition-all duration-150 hover:bg-primary/20 flex items-center justify-center"
